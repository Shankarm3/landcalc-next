...
export async function GET() {
  ...
  const url = `https://gnews.io/api/v4/top-headlines?category=business&lang=en&country=in&max=5&apikey=${process.env.GNEWS_API_KEY}`;

   const isLocalhost = process.env.NODE_ENV === "development";

   console.log(`Target Routing API URL NEWS=> ${url}`);
